...
| --- | --- | --- | --- |
| 01_data/evidence/m002_s02_attempt_{attempt}/joined_ledger.json | evidence | coder | create_fresh_per_attempt |
...
- 03_experiments/m002_acquisition_record.md
writes:
- path: 01_data/evidence/m002_s02_attempt_{attempt}/joined_ledger.json
